...
# ── New widgets ────────────────────────────────────
check        "uv_index requested from API"                  "uv_index"
check        "precipitation requested from API"             "precipitation"
check        "sunrise requested from daily API"             "sunrise"
check        "sunset requested from daily API"              "sunset"
check        "uvRisk helper function present"               "uvRisk"
check        "parseDailyTime helper function present"       "parseDailyTime"
check        "UV badge element present in HTML"             "uv-badge"
check        "UV badge CSS classes defined"                 "uv-low|uv-moderate|uv-high"
check        "Precip element present in HTML"               "id=\"precip\""
check        "Sunset element present in HTML"               "id=\"sunset\""
check        "Today's range high element present"           "id=\"avg-high\""
check        "Today's range low element present"            "id=\"avg-low\""
check        "UV value guarded with isFinite"               "isFinite.*uv|uv.*isFinite"
check        "Sunset time parsed with regex (no eval)"      "parseDailyTime"
check        "Sunrise sub-label shown"                      "sunrise-sub"
check        "Precip sub-label shown"                       "precip-sub"
